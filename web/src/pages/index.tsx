...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent){
    ...
    try {
      ...
      alert('Bolão criado com sucesso, código na área de transferência')

      setPoolTitle('')
    } catch (err) {
      console.log('Falha ao criar bolão, tente novamente!')
    }
  }
  ...
  return (
    <div className="max-w-6xl h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <p className="mt-a text-sm text-gray-300 leading-relaxed">
